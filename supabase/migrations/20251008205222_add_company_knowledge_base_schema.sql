/*
  ...
  1. New Tables
    - `company_profiles`
      - Stores organization information, industry, mission, products, value propositions
      - Links to teams for multi-tenant support
      - Includes brand voice settings and messaging guidelines
    
    - `knowledge_documents`
      - Stores uploaded PDF files and extracted text content
      - Tracks document metadata, type, and processing status
      - Links to company profiles
    
    - `knowledge_websites`
      - Stores website URLs and crawled content
      - Tracks last sync date and content sections
      - Links to company profiles
    
    - `knowledge_embeddings`
      - Stores vector embeddings for semantic search
      - Links to source documents or website content
      - Includes chunk text and metadata
    
    - `company_training_sessions`
      - Tracks when knowledge base was updated
      - Records which agents were affected
      - Stores training metrics and validation results
    
    - `knowledge_usage_logs`
      - Tracks which knowledge sources agents reference
      - Stores usage context and effectiveness metrics
      - Enables knowledge gap analysis
  ...
  3. Security
    ...
    - Team-based access control for company knowledge
    - Owner and team member policies for read/write access
*/
